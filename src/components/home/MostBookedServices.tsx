...
export default function MostBookedServices({
  ...
  const featured = [
    ...
    },
    {
      ...
      image: homepageImages.service_washing || '/images/service_washing_machine.jpg',
    ...
    },
    {
      ...
      image: homepageImages.service_microwave || '/images/service_microwave_oven.jpg',
    ...
    },
    {
      ...
      image: homepageImages.service_led_tv || '/images/service_smart_led_tv.jpg',
